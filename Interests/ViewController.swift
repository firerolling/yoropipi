...
class ViewController: UIViewController {
    ...
    func uploadNewDate() {
        let new = selectedDate.text! + "   " + selectedDateAndTime.text!
        let newDate = Post(user: PFUser.currentUser()!, postText: new, numberOfLikes: 0, interestId: interest.objectId!, isSelected: false)
        newDate.saveInBackgroundWithBlock { (success, error) -> Void in
            if error == nil {
