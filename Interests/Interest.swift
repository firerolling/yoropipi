...
public class Interest: PFObject, PFSubclassing
{
    ...
    init(title: String, interestDescription: String, imageFile: PFFile, numberOfMembers: Int, numberOfChats: Int, numberOfPlaces: Int, numberOfPosts: Int, createdUser: String, isDesided: Bool, placeIsDesided: Bool, selectedDate: String, selectedPlace: String, selectedUrl: String)
    {
        super.init()
        self.title = title
